...
- [] **1.1 Cargar mapa**: Importar un archivo (`.txt` o `.csv`) con el mapa codificado y mostrarlo en una interfaz gráfica.
- [] **1.2 Consultar celda**: Obtener el valor de una coordenada y mostrar su significado (ej. “(7,A) es muro”).
